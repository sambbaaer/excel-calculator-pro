    ...
    public function add_inline_styles()
    {
        ...
        $get_color_default = function ($key, $mode = 'light') use ($color_settings) {
            ...
            $light_defaults = array(
                'background_color_light' => '#ffffff', 'text_color_light' => '#2c3e50', 'text_light_light' => '#6c757d',
                'border_color_light' => '#e1e5e9', 'input_bg_light' => '#ffffff', 'input_border_light' => '#dee2e6',
                'input_focus_border_light' => $color_settings['primary_color'] ?? '#007cba',
                'field_group_bg_light' => '#f8f9fa', 'field_group_hover_bg_light' => '#e9ecef',
                'output_group_bg_gradient_start_light' => '#e8f4f8', 'output_group_bg_gradient_end_light' => '#f0f9ff',
                'output_group_border_light' => '#b3d9e6', 'output_field_bg_light' => '#ffffff',
            ...
            $dark_defaults = array(
                'background_color_dark' => '#1e1e1e', 'text_color_dark' => '#e0e0e0', 'text_light_dark' => '#adb5bd',
                'border_color_dark' => '#404040', 'input_bg_dark' => '#2d2d2d', 'input_border_dark' => '#505050',
                'input_focus_border_dark' => $color_settings['secondary_color'] ?? '#00a0d2',
                'field_group_bg_dark' => '#2a2a2a', 'field_group_hover_bg_dark' => '#313131',
                'output_group_bg_gradient_start_dark' => '#1a3a4a', 'output_group_bg_gradient_end_dark' => '#0f2f3f',
                'output_group_border_dark' => '#4a6c7a', 'output_field_bg_dark' => '#2d2d2d',
